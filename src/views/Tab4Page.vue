  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <ion-searchbar color="light" v-model="searchQuery" :debounce="500" @ionInput="filterLocations"
        placeholder="Buscar ubicaciones..."></ion-searchbar>
      <ion-list>
        <ion-item v-for="location in filteredLocations" :key="location.id" button
          @click="push(`/location/${location.id}`)">
          <ion-label>
            <h2>{{ location.name }}</h2>
      ...
      <ion-infinite-scroll threshold="100px" @ionInfinite="loadLocations">
...
import { IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonList, IonItem, IonLabel, IonInfiniteScroll, IonInfiniteScrollContent, useIonRouter } from '@ionic/vue';
